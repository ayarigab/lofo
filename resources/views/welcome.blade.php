    ...
    <section class="relative py-20 bg-gray-50">
        ...
        <div class="max-w-6xl px-6 mx-auto relative z-20">
            <div class="grid gap-12 md:grid-cols-2">
                <div>
                    <h2 class="mb-6 text-3xl font-bold text-sky-900 sm:text-4xl">Report your Lost Item</h2>
                    <p class="mb-8 text-lg text-gray-600">We'd love to help you with your lost items. Go on submit a form or use
