<form wire:submit.prevent="updatePassword" class="space-y-4 text-start">
    ...
    <div class="mb-6">
        ...
        <input wire:model="new_password_confirmation" type="password" id="new_password_confirmation" required
    ...
    <div class="flex flex-col items-center justify-center">
        <button type="submit"
            class="hover-scale inline-flex items-center justify-center w-1/2 h-10 px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 rounded-full bg-green-600 hover:bg-green-700 focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 focus:shadow-outline focus:outline-none">
