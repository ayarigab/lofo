                ...
                <aside class="w-full lg:w-1/4 xl:w-1/5 lg:border-r lg:border-gray-200 lg:pr-6">
                    <div class="sticky top-24 space-y-6">
                        <div class="p-4 bg-white rounded-3xl shadow">
                            <h3 class="text-lg font-medium mb-3">Search Items</h3>
                            <div class="relative">
                                ...
                                <div class="w-full overflow-hidden rounded-2xl">
                                    <label
                                        ...
                                        <div class="block ml-2">
                                            <div class="w-full text-lg font-semibold">{{ ucfirst($statusOption) }}</div>
                                            <div class="w-full text-xs text-gray-400">
                                                ...
                                                @break
                                                @case('claimed')
                                                Items claimed by users
                                                @break
                                                @case('approved')
                                                Items verified by admin
                                                @break
                                                @case('archived')
                                                Old archived items
                                                @break
                                        ...
                                        <span class="sr-only">Select {{ ucfirst($statusOption) }}</span>
                                    </label>
                                </div>
                                @endforeach
                            </div>
                ...
                <main class="w-full lg:w-3/4 xl:w-4/5">
                    <div class="mb-8 text-center md:text-left">
                        ...
                        <p class="mt-3 text-lg text-gray-600 max-w-3xl">
                            Browse through the list of lost items reported by our community. Found something?
                    ...
                    <div wire:loading.remove class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <span
                                                ...
                                                {{ $lostItem->category->name ?? 'Uncategorized' }}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-span-full text-center py-12 animate-fade-in">
                            ...
                            <p class="mt-1 text-gray-500">
                                ...
                                @else
                                There are currently no lost items reported.
                                @endif
                            </p>
                            <div class="mt-6">
