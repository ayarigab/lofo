<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 193" {{ $attributes }}>
    <defs>
    ...
    <path d="M119.2 44.5 63.9 64.4l-5-1.3-29.4-7.6L7.7 21.7l.4-.4L89.9 0h.1L118 42l.5.8c.6.9.7 1.4.7 1.8Z"
        fill="url(#d)" />
    ...
    <path
        ...
        fill="url(#f)" />
    <path d="m241.1 21.8-11 18.3-40.5 17.2-4 1.7-66-14.5a6.2 6.2 0 0 1 1-2.8l25.2-36.6s0-.1.2 0l95 16.2.1.5Z"
        fill="url(#g)" />
    ...
    <path
        ...
        fill="#BF9064" />
    <path d="m141.4 100-.7 91.9h-.5L44.3 156c-.5-.2-.6-.8-.6-1.4L39.5 73v-.1h.1v-.1l.1-.2L141 99.9c0 .1.3 0 .4 0Z"
        fill="#BD8F63" />
    ...
    <path
        ...
        fill="#CD9C6B" />
    <path d="M96 109.1h.1l-.3-20.4c0-.6-.2-2-1-2.6l-37-22.4-17.2-4.4L78 81.7c.9.6 1 1.8 1 2.6l.6 19.8v.1l16.3 5Z"
        fill="url(#l)" />
    <path
    ...
    <path d="m216 66.3-4 80c-.1.6-.3.7-.9 1l-70 44.4a1 1 0 0 1-.3.2l.6-92c.2 0 .4.2.4 0v-.1L216 66.2v.1Z"
        fill="#DBAD77" />
    ...
    <path
        ...
        fill="#D7AA77" />
    <path d="m175 105.5.1.1 12-6v-.2l.6-19.5c0-1 .6-2 1.5-2.8l39.4-35.5-12 5.1-39.7 36c-1 1-1.3 2.2-1.4 3.2l-.5 19.6Z"
        fill="url(#n)" />
